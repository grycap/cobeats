...
cat final.txt|sort|awk 'BEGIN { FS= "|" ; OFS=SUBSEP="|"}{arr[$1,$2,substr($3,1,1)]+=$4 }END {for (i in arr) print i,arr[i]}'|sort|awk -F"|" '{print $0}'|sort|awk -F"|"  '{print $4" "$4" "$4}' > /home/ubuntu/Mytest/cobeats/scm/v0.2/iofiles/system_status_fifa_corto.csv

head -100  /home/ubuntu/Mytest/cobeats/scm/v0.2/iofiles/system_status_fifa_corto.csv
wc -l  /home/ubuntu/Mytest/cobeats/scm/v0.2/iofiles/system_status_fifa_corto.csv
